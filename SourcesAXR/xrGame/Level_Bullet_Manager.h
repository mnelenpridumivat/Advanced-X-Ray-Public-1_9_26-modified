...
//.	xrCriticalSection		m_Lock				;
	...
	xr_set<FlamethrowerTrace::CManager*> m_flamethrower_managers;
#endif // #ifdef DEBUG
...
public:
	...
	void 					Load				();
	void 					Clear				();
	SBullet& 				AddBullet			(const Fvector& position, const Fvector& direction, float starting_speed,
	...
	void MarkFlamethrowerTraceToDraw(FlamethrowerTrace::CManager* Manager);
#endif
};
