...
void CStateBloodsuckerVampireAbstract::finalize()
{
	...
	CAI_Bloodsucker::m_time_last_vampire				= CRenderDevice::GetInstance()->dwTimeGlobal;
}
...
bool CStateBloodsuckerVampireAbstract::check_start_conditions()
{
	...
	if (CAI_Bloodsucker::m_time_last_vampire + object->m_vampire_min_delay > CRenderDevice::GetInstance()->dwTimeGlobal) return false;
