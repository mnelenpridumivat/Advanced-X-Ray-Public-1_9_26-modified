...
{
	SZoneObjectInfo():object(NULL),zone_ignore(false),dw_time_in_zone(0),f_time_affected(CRenderDevice::GetInstance()->fTimeGlobal),small_object(false),nonalive_object(false) {}
	CGameObject*			object; 
	bool					small_object;
