...
void CActionBase<CScriptGameObject>::script_register(lua_State *L)
{
	...
	[
		class_<CScriptActionBase,CScriptActionWrapper>("action_base")
			...
			.def("add_precondition",			static_cast<void (CScriptActionBase::*)(const CScriptActionBase::COperatorCondition&)>(&
				     CScriptActionBase::add_condition))
			.def("add_effect",					static_cast<void (CScriptActionBase::*)(const CScriptActionBase::COperatorCondition&)>(&CScriptActionBase::add_effect))
			.def("remove_precondition",			static_cast<void (CScriptActionBase::*)(const CScriptActionBase::COperatorCondition::_condition_type&)>(&
				     CScriptActionBase::remove_condition))
			.def("remove_effect",				static_cast<void (CScriptActionBase::*)(const CScriptActionBase::COperatorCondition::_condition_type&)>(&
