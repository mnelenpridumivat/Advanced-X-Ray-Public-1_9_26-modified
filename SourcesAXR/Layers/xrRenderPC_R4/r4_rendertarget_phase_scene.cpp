...
void	CRenderTarget::phase_scene_prepare	()
{
		...
		)
	{
      ...
      if( !RImplementation.o.dx10_msaa )
   		u_setrt	(CRenderDevice::GetInstance()->dwWidth, CRenderDevice::GetInstance()->dwHeight,rt_Position->pRT,NULL,NULL,HW.pBaseZB );
      else
         u_setrt	(CRenderDevice::GetInstance()->dwWidth, CRenderDevice::GetInstance()->dwHeight,rt_Position->pRT,NULL,NULL,rt_MSAADepth->pZRT );
	...
	else
	{
      ...
      {
         u_setrt	(CRenderDevice::GetInstance()->dwWidth, CRenderDevice::GetInstance()->dwHeight,HW.pBaseRT,NULL,NULL,rt_MSAADepth->pZRT );
         //CHK_DX	( HW.pDevice->Clear	( 0L, NULL, D3DCLEAR_ZBUFFER|D3DCLEAR_STENCIL, 0x0, 1.0f, 0L) );
         HW.pContext->ClearDepthStencilView(rt_MSAADepth->pZRT, D3D_CLEAR_DEPTH|D3D_CLEAR_STENCIL, 1.0f, 0);
      }
	}
