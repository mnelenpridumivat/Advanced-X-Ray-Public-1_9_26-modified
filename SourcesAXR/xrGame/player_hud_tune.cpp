...
{
	Fmatrix							cam_m;
	cam_m.i.set						(CRenderDevice::GetInstance()->vCameraRight);
	cam_m.j.set						(CRenderDevice::GetInstance()->vCameraTop);
	cam_m.k.set						(CRenderDevice::GetInstance()->vCameraDirection);
	cam_m.c.set						(CRenderDevice::GetInstance()->vCameraPosition);
