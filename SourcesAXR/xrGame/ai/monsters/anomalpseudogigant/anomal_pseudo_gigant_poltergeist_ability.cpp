...
CAnomalGigPolterSpecialAbility::~CAnomalGigPolterSpecialAbility()
{
	CParticlesObject::Destroy	(m_particles_object);
	CParticlesObject::Destroy	(m_particles_object_electro);
}

void CAnomalGigPolterSpecialAbility::load(LPCSTR section)
{
...
void CAnomalGigPolterSpecialAbility::update_schedule()
{
	if (m_object->g_Alive()) {
...
void CAnomalGigPolterSpecialAbility::on_hide()
{
...
void CAnomalGigPolterSpecialAbility::on_show()
{
...
void CAnomalGigPolterSpecialAbility::update_frame()
{
...
/*void CAnomalGigPolterSpecialAbility::on_die()
{
...
void CAnomalGigPolterSpecialAbility::on_hit(SHit* pHDS)
{
...
void CAnomalPseudoGigant::PhysicalImpulse	(const Fvector &position)
{
...
void CAnomalPseudoGigant::StrangeSounds(const Fvector &position)
{
