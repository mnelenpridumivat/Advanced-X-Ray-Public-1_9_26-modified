...
public:
	...
	IC u16					GetRandomBone			(){ u16 l_PBCount=static_cast<u16>(m_Bones.size()); if(l_PBCount) return m_Bones[static_cast<u16>(Random.randI(l_PBCount))].index; else return BI_NONE;}
