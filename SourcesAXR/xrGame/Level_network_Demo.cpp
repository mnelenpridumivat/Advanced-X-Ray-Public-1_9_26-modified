...
void CLevel::StartPlayDemo()
{
	...
	m_StartGlobalTime	= CRenderDevice::GetInstance()->dwTimeGlobal;
...
void CLevel::RestartPlayDemo()
{
	...
	m_StartGlobalTime	= CRenderDevice::GetInstance()->dwTimeGlobal - m_starting_spawns_dtime;
...
{
	m_demo_header.m_time_global			= CRenderDevice::GetInstance()->dwTimeGlobal;
...
{
	m_writer->w_u32	(CRenderDevice::GetInstance()->dwTimeGlobal - m_demo_header.m_time_global);
...
{
	u32 tdelta = CRenderDevice::GetInstance()->dwTimeGlobal - m_StartGlobalTime;
