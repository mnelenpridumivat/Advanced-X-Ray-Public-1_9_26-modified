...
public:
    ...
    Flags32				m_Flags;
public:
						ListItem		(int _type):type(_type),prop_color(0),item(nullptr),key(nullptr),tag(0),icon_index(-1),OnDrawThumbnail(nullptr),OnItemFocused(nullptr),m_Object(nullptr){m_Flags.zero();}
	virtual 			~ListItem		(){};
