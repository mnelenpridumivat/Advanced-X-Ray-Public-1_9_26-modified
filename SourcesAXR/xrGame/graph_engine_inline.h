...
IC	CGraphEngine::CGraphEngine		(u32 max_vertex_count)
{
	...
	m_algorithm->data_storage().set_min_bucket_value		(static_cast<_dist_type>(0));
	m_algorithm->data_storage().set_max_bucket_value		(static_cast<_dist_type>(2000));
...
{
#ifndef AI_COMPILER
	CRenderDevice::GetInstance()->Statistic->AI_Path.Begin();
...
#ifndef AI_COMPILER
	CRenderDevice::GetInstance()->Statistic->AI_Path.End();
#endif
	return						(successfull);
#ifndef AI_COMPILER
	STOP_PROFILE
