#include "stdafx.h"
#include "particle_domain_Cone.h"
...
BOOL PAPI::pDomainCone::Within(const pVector& pos) const
{
...
void PAPI::pDomainCone::Generate(pVector& pos) const
{
...
void PAPI::pDomainCone::transform(PAPI::pDomain* domain, const Fmatrix& m)
{
...
void PAPI::pDomainCone::transform_dir(PAPI::pDomain* domain, const Fmatrix& m)
{
	Fmatrix M = m;
	M.c.set(0, 0, 0);
	transform(domain, M);
...
PAPI::pDomainCone::pDomainCone(PDomainEnum dtype,
