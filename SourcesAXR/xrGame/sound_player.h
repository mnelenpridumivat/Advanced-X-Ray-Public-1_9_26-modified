		...
		bool			operator()				(CSoundSingle &sound)
		{
			...
			bool		result = 
				...
				(
					...
					(sound.m_stop_time <= CRenderDevice::GetInstance()->dwTimeGlobal)
				);
			if (result)
				sound.destroy					();
			return								(result);
...
public:
	...
	virtual	void		reload						(LPCSTR section);
			...
			void		clear						();
			void		play						(u32 internal_type, u32 max_start_time = 0, u32 min_start_time = 0, u32 max_stop_time = 0, u32 min_stop_time = 0, u32 id = static_cast<u32>(-1));
