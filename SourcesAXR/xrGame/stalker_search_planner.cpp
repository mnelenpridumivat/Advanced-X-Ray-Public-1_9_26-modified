...
void CStalkerSearchPlanner::add_evaluators			()
{
	...
	add_evaluator			(eWorldPropertyEnemyLocationReached	,xr_new<CStalkerPropertyEvaluatorMember>	(static_cast<CPropertyStorage*>(nullptr),eWorldPropertyEnemyLocationReached,true,true,"enemy location reached"));
	add_evaluator			(eWorldPropertyAmbushLocationReached,xr_new<CStalkerPropertyEvaluatorMember>	(static_cast<CPropertyStorage*>(nullptr),eWorldPropertyAmbushLocationReached,true,true,"ambush location reached"));
}
