...
{
	if ((CRenderDevice::GetInstance()->dwTimeGlobal - m_last_chunksize_update_time) < 1000)
		return;
	...
	} else //peak is reached
	{
		...
		if ((CRenderDevice::GetInstance()->dwTimeGlobal - m_last_chunksize_update_time) < 3000)
			return;
	...
	m_last_chunksize_update_time	= CRenderDevice::GetInstance()->dwTimeGlobal;
}
