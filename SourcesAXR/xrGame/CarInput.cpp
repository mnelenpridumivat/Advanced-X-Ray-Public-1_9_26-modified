...
/*
	case kFWD:		
		...
		else								m_vCamDeltaHP.y += active_camera->rot_speed.y*CRenderDevice::GetInstance()->fTimeDelta;
		break;
	case kBACK:		
	...
	case kL_STRAFE: 
		...
		else								m_vCamDeltaHP.x -= active_camera->rot_speed.x*CRenderDevice::GetInstance()->fTimeDelta;
		break;
	case kR_STRAFE: 
