...
BOOL CProjector::net_Spawn(CSE_Abstract* DC)
{
	...
	//////////////////////////////////////////////////////////////////////////
	CBoneInstance& b_x = reinterpret_cast<IKinematics*>(Visual())->LL_GetBoneInstance(bone_x.id);
	b_x.set_callback(bctCustom,BoneCallbackX,this);

	CBoneInstance& b_y = reinterpret_cast<IKinematics*>(Visual())->LL_GetBoneInstance(bone_y.id);
...
void CProjector::TurnOn()
{
	...
	IKinematics *visual = reinterpret_cast<IKinematics*>(Visual());
...
void CProjector::TurnOff()
{
	...
	reinterpret_cast<IKinematics*>(Visual())->LL_SetBoneVisible(guid_bone, FALSE, TRUE);
}
