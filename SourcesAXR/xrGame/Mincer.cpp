...
{
	return inherited::feel_touch_contact(O)&&O->IsA(CPhysicsShellHolder::StaticClass());
}
...
{
	return	(!GO->IsA(CActor::StaticClass()) ? m_fBlowoutRadiusPercent:m_fActorBlowoutRadiusPercent);
}
