...
public:
	...
	IC		void			SetState			(u32 v)				{m_hud_item_state = v; m_dw_curr_state_time= CRenderDevice::GetInstance()->dwTimeGlobal;ResetSubStateTime();}
	IC		void			SetNextState		(u32 v)				{m_nextState = v;}
	IC		u32				CurrStateTime		() const			{return CRenderDevice::GetInstance()->dwTimeGlobal-m_dw_curr_state_time;}
	IC		void			ResetSubStateTime	()					{m_dw_curr_substate_time= CRenderDevice::GetInstance()->dwTimeGlobal;}
