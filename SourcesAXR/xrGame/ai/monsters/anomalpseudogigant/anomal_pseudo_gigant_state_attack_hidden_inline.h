...
#define CStateAnomalPseudoGigantAttackHiddenAbstract CStateAnomalPseudoGigantAttackHidden<_Object>

#define DIST_TO_PATH_END	1.5f


TEMPLATE_SPECIALIZATION
CStateAnomalPseudoGigantAttackHiddenAbstract::CStateAnomalPseudoGigantAttackHidden (_Object *obj) : inherited(obj)
{
	add_state	(eStateAttack_MoveToHomePoint,	xr_new<CStateMonsterAttackMoveToHomePoint<_Object> >(obj));	
}

TEMPLATE_SPECIALIZATION
void CStateAnomalPseudoGigantAttackHiddenAbstract::initialize()
{
...
TEMPLATE_SPECIALIZATION
void   CStateAnomalPseudoGigantAttackHiddenAbstract::select_target_for_move ()
{
...
TEMPLATE_SPECIALIZATION
bool CStateAnomalPseudoGigantAttackHiddenAbstract::check_home_point()
{
...
TEMPLATE_SPECIALIZATION
void CStateAnomalPseudoGigantAttackHiddenAbstract::execute()
{
	if	( check_home_point() )
	{
...
#undef CStateAnomalPseudoGigantAttackHiddenAbstract