...
void CEncyclopediaArticle::load_shared	(LPCSTR)
{
	...
	if(ltx)
	{
		...
		Frect				tex_rect;
		tex_rect.x1			= static_cast<float>(pSettings->r_u32(ltx, "inv_grid_x") * INV_GRID_WIDTH(GameConstants::GetUseHQ_Icons()));
		tex_rect.y1			= static_cast<float>(pSettings->r_u32(ltx, "inv_grid_y") * INV_GRID_HEIGHT(GameConstants::GetUseHQ_Icons()));
		tex_rect.x2			= static_cast<float>(pSettings->r_u32(ltx, "inv_grid_width") * INV_GRID_WIDTH(GameConstants::GetUseHQ_Icons()));
		tex_rect.y2			= static_cast<float>(pSettings->r_u32(ltx, "inv_grid_height") * INV_GRID_HEIGHT(GameConstants::GetUseHQ_Icons()));
