...
void CStateBurerAttackGravi<Object>::ExecuteGraviStart()
{
	...
	m_time_gravi_started			= CRenderDevice::GetInstance()->dwTimeGlobal;
...
void CStateBurerAttackGravi<Object>::ExecuteGraviContinue()
{
	...
	if ( m_time_gravi_started + static_cast<u32>(time_to_hold) < CRenderDevice::GetInstance()->dwTimeGlobal )
	{
