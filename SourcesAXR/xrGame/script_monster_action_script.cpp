...
void CScriptMonsterAction::script_register(lua_State *L)
{
	...
	[
		class_<CScriptMonsterAction>("act")
			.enum_("type")
			[
				value("rest",	static_cast<int>(MonsterSpace::eGA_Rest)),
				value("eat",	static_cast<int>(MonsterSpace::eGA_Eat)),
				value("attack",	static_cast<int>(MonsterSpace::eGA_Attack)),
				value("panic",	static_cast<int>(MonsterSpace::eGA_Panic))
			]
