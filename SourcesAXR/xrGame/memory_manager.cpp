...
//	if (obj) {
//		Msg						("------------------------------------------------------");
//		Msg						("[%6d] make_object_visible_somewhen [%s] = %x",CRenderDevice::GetInstance()->dwTimeGlobal,*enemy->cName(),obj->m_squad_mask.get());
//	}
//	LogStackTrace				("-------------make_object_visible_somewhen-------------");
	...
	VERIFY						(obj1);
//	if (obj1)
//		Msg						("[%6d] make_object_visible_somewhen [%s] = %x",CRenderDevice::GetInstance()->dwTimeGlobal,*enemy->cName(),obj1->m_squad_mask.get());
