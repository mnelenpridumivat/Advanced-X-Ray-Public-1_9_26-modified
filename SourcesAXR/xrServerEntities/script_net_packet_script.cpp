...
//			.def("w_s8",			&NET_Packet::w_s8			)
			...
			.def("w_stringZ",		static_cast<void (NET_Packet::*)(LPCSTR, bool)>(&NET_Packet::w_stringZ))
...
//			.def("r",				&NET_Packet::r				)
			...
			.def("r_vec3",			static_cast<void (NET_Packet::*)(Fvector&, bool)>(&NET_Packet::r_vec3)			,pure_out_value<2>())
			.def("r_float",			static_cast<void (NET_Packet::*)(float&, bool)>(&NET_Packet::r_float))
			.def("r_u64",			static_cast<void (NET_Packet::*)(u64&, bool)>(&NET_Packet::r_u64))
			.def("r_s64",			static_cast<void (NET_Packet::*)(s64&, bool)>(&NET_Packet::r_s64))
			.def("r_u32",			static_cast<void (NET_Packet::*)(u32&, bool)>(&NET_Packet::r_u32))
			.def("r_s32",			static_cast<void (NET_Packet::*)(s32&, bool)>(&NET_Packet::r_s32))
			.def("r_u16",			static_cast<void (NET_Packet::*)(u16&, bool)>(&NET_Packet::r_u16))
			.def("r_s16",			static_cast<void (NET_Packet::*)(s16&, bool)>(&NET_Packet::r_s16))
			.def("r_u8",			static_cast<void (NET_Packet::*)(u8&, bool)>(&NET_Packet::r_u8))
			.def("r_s8",			static_cast<void (NET_Packet::*)(s8&, bool)>(&NET_Packet::r_s8))
			.def("r_bool",			&r_bool						)
			.def("r_float",			static_cast<float (NET_Packet::*)()>(&NET_Packet::r_float))
			.def("r_u64",			static_cast<u64 (NET_Packet::*)()>(&NET_Packet::r_u64))
			.def("r_s64",			static_cast<s64 (NET_Packet::*)()>(&NET_Packet::r_s64))
			.def("r_u32",			static_cast<u32 (NET_Packet::*)()>(&NET_Packet::r_u32))
			.def("r_s32",			static_cast<s32 (NET_Packet::*)()>(&NET_Packet::r_s32))
			.def("r_u16",			static_cast<u16 (NET_Packet::*)()>(&NET_Packet::r_u16))
			.def("r_s16",			static_cast<s16 (NET_Packet::*)()>(&NET_Packet::r_s16))
			.def("r_u8",			static_cast<u8 (NET_Packet::*)()>(&NET_Packet::r_u8))
			.def("r_s8",			static_cast<s8 (NET_Packet::*)()>(&NET_Packet::r_s8))
			.def("r_float_q16",		static_cast<void (NET_Packet::*)(float&, float, float, bool)>(&NET_Packet::r_float_q16)	)
			.def("r_float_q8",		static_cast<void (NET_Packet::*)(float&, float, float, bool)>(&NET_Packet::r_float_q8)	)
