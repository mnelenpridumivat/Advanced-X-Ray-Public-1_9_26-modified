...
CAnomalGigPolterFlame::CAnomalGigPolterFlame(CAnomalPseudoGigant* gigant) : inherited (gigant)
{
}

CAnomalGigPolterFlame::~CAnomalGigPolterFlame()
{
}

void CAnomalGigPolterFlame::load(LPCSTR section)
{
...
void CAnomalGigPolterFlame::create_flame(const CObject *target_object)
{
	Fvector position;
...
struct remove_predicate {
	bool	operator() (CAnomalGigPolterFlame::SFlameElement *element)	{
		return (!element);
	}
};


void CAnomalGigPolterFlame::update_schedule()
{
...
void CAnomalGigPolterFlame::on_destroy()
{
...
bool CAnomalGigPolterFlame::get_valid_flame_position(const CObject *target_object, Fvector &res_pos)
{
