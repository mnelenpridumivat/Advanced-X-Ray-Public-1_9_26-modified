...
public:
	...
	bool            home_in_danger     () { return CRenderDevice::GetInstance()->dwTimeGlobal < m_home_danger_end_tick; }
	void            set_home_in_danger () { m_home_danger_end_tick = CRenderDevice::GetInstance()->dwTimeGlobal + m_home_danger_mode_time; }
