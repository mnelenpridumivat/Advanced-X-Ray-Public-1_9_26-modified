...
void show_animations		()
{
	...
	const ANIMATION_STATS_PAIR		**const animations = static_cast<ANIMATION_STATS_PAIR const**>(_alloca(animation_count * sizeof(ANIMATION_STATS_PAIR*)));
...
void show_blends			()
{
	...
	const BLEND_STATS_PAIR			**const blends = static_cast<BLEND_STATS_PAIR const**>(_alloca(blend_count * sizeof(BLEND_STATS_PAIR*)));
