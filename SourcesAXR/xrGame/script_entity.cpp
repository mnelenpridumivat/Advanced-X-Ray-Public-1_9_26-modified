...
//			Msg			("%6d Processing action : %s",CRenderDevice::GetInstance()->dwTimeGlobal,*l_tpEntityAction->m_tAnimationAction.m_caAnimationToPlay);
#endif
...
#ifdef _DEBUG
//		if (!xr_strcmp("m_stalker_wounded",*object().cName()))
//			Msg			("%6d Action completed : %s",CRenderDevice::GetInstance()->dwTimeGlobal,*l_tpEntityAction->m_tAnimationAction.m_caAnimationToPlay);
#endif
...
#ifdef _DEBUG
//				Msg									("%6d Starting sound %s",CRenderDevice::GetInstance()->dwTimeGlobal,*l_tSoundAction.m_caSoundToPlay);
#endif
...
//			Msg			("%6d Object %s, position [%f][%f][%f]",CRenderDevice::GetInstance()->dwTimeGlobal,*l_tpGameObject->cName(),VPUSH(l_tpGameObject->Position()));
...
#ifdef DEBUG
			//if (!xr_strcmp("m_stalker_wounded",*object().cName()))
			//	Msg				("%6d Playing animation : %s , Object %s",CRenderDevice::GetInstance()->dwTimeGlobal,*GetCurrentAction()->m_tAnimationAction.m_caAnimationToPlay, *object().cName());
#endif
