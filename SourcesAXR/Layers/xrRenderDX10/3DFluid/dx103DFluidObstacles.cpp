...
{
	m_lstRenderables.erase(m_lstRenderables.begin(), m_lstRenderables.end());
	m_lstShells.erase(m_lstShells.begin(), m_lstShells.end());
	m_lstElements.erase(m_lstElements.begin(), m_lstElements.end());
