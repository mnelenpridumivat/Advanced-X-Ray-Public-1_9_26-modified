...
CAnomalGigPolterTele::CAnomalGigPolterTele(CAnomalPseudoGigant* gigant) : inherited (gigant),m_pmt_object_collision_damage(0.5f)
{
}

CAnomalGigPolterTele::~CAnomalGigPolterTele()
{
}

void CAnomalGigPolterTele::load(LPCSTR section)
{
...
bool CAnomalGigPolterTele::trace_object(CObject *obj, const Fvector &target)
{
	Fvector			trace_from;
...
bool CAnomalGigPolterTele::tele_raise_objects()
{
...
void CAnomalGigPolterTele::tele_fire_objects()
{
