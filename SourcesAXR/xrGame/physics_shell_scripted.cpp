...
void cphysics_shell_scripted::script_register( lua_State *L )
{
	module(L)
		[
			...
			.def("get_element_by_bone_name",	static_cast<cphysics_element_scripted*(cphysics_shell_scripted::*)(LPCSTR)>(&cphysics_shell_scripted::get_Element))
			.def("get_element_by_bone_id",		static_cast<cphysics_element_scripted*(cphysics_shell_scripted::*)(u16)>(&cphysics_shell_scripted::get_Element))
			...
			.def("get_joint_by_bone_name",		static_cast<cphysics_joint_scripted*(cphysics_shell_scripted::*)(LPCSTR)>(&cphysics_shell_scripted::get_Joint))
			.def("get_joint_by_bone_id",		static_cast<cphysics_joint_scripted*(cphysics_shell_scripted::*)(u16)>(&cphysics_shell_scripted::get_Joint))
