...
void CStalkerDangerInDirectionPlanner::add_evaluators				()
{
	...
	add_evaluator			(eWorldPropertyPositionHolded	,xr_new<CStalkerPropertyEvaluatorMember>			(static_cast<CPropertyStorage*>(nullptr),eWorldPropertyPositionHolded,true,true,"position is held"));
	add_evaluator			(eWorldPropertyEnemyDetoured	,xr_new<CStalkerPropertyEvaluatorMember>			(static_cast<CPropertyStorage*>(nullptr),eWorldPropertyEnemyDetoured,true,true,"danger is detoured"));
}
