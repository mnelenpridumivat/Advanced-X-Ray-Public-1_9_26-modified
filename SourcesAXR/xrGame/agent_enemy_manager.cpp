...
//	Msg								("[%6d] assigned = %x",CRenderDevice::GetInstance()->dwTimeGlobal,assigned);
//	ENEMIES::iterator				I = m_enemies.begin();
//	ENEMIES::iterator				E = m_enemies.end();
//	for ( ; I != E; ++I)
//		Msg							("[%6d] [%s] = %x",CRenderDevice::GetInstance()->dwTimeGlobal,*(*I).m_object->cName(),(*I).m_distribute_mask.get());
}
