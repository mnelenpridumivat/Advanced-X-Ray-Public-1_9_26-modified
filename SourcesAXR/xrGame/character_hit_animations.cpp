...
*/
	...
	base_bone	= reinterpret_cast<IKinematics*>(&ca)->LL_BoneID("bip01_spine1");//bip01_spine1
...
void character_hit_animation_controller::PlayHitMotion( const Fvector &dir, const Fvector &bone_pos, u16 bi, CEntityAlive &ea )const
{
	...
	IKinematicsAnimated* CA = reinterpret_cast<IKinematicsAnimated*>( pV );
	IKinematics* K = reinterpret_cast<IKinematics*>( pV );
...
{
	IKinematics* CA = reinterpret_cast<IKinematics*>(ea.Visual());
