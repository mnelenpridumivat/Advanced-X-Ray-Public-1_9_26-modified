...
void CShootingObject::LoadFireParams( LPCSTR section )
{
	...
	{
		fvHitPower[egdVeteran]	= static_cast<float>(atof(_GetItem(*s_sHitPower, 1, buffer)));//�� ���������� ��� ��� ������ ��������
	}
	if (num_game_diff_param>2)//���� ����� ������ �������� ����
	{
		fvHitPower[egdStalker]	= static_cast<float>(atof(_GetItem(*s_sHitPower, 2, buffer)));//�� ���������� ��� ��� ������ ��������
	}
	if (num_game_diff_param>3)//���� ����� �������� �������� ����
	{
		fvHitPower[egdNovice]	= static_cast<float>(atof(_GetItem(*s_sHitPower, 3, buffer)));//�� ���������� ��� ��� ������ �������
	}

	num_game_diff_param=_GetItemCount(*s_sHitPowerCritical);//����� ����������� ����������
	if (num_game_diff_param>1)//���� ����� ������ �������� ����
	{
		fvHitPowerCritical[egdVeteran]	= static_cast<float>(atof(_GetItem(*s_sHitPowerCritical, 1, buffer)));//�� ���������� ��� ��� ������ ��������
	}
	if (num_game_diff_param>2)//���� ����� ������ �������� ����
	{
		fvHitPowerCritical[egdStalker]	= static_cast<float>(atof(_GetItem(*s_sHitPowerCritical, 2, buffer)));//�� ���������� ��� ��� ������ ��������
	}
	if (num_game_diff_param>3)//���� ����� �������� �������� ����
	{
		fvHitPowerCritical[egdNovice]	= static_cast<float>(atof(_GetItem(*s_sHitPowerCritical, 3, buffer)));//�� ���������� ��� ��� ������ �������
	}
