...
void CALifeMonsterMovementManager::script_register	(lua_State *L)
{
	...
	[
		class_<CALifeMonsterMovementManager>("CALifeMonsterMovementManager")
			...
			.def("path_type",	static_cast<void (CALifeMonsterMovementManager::*)(const EPathType&)>(&CALifeMonsterMovementManager::path_type))
			.def("path_type",	static_cast<const EPathType & (CALifeMonsterMovementManager::*)() const>(&CALifeMonsterMovementManager::path_type))
