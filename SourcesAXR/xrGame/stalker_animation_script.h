...
public:
	IC						CStalkerAnimationScript	(const MotionID &animation, bool hand_usage, bool use_movement_controller, Fmatrix const* transform = nullptr, bool local_animation = true);
