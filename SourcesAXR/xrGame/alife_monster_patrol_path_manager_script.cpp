...
void CALifeMonsterPatrolPathManager::script_register	(lua_State *L)
{
	...
	[
		class_<CALifeMonsterPatrolPathManager>("CALifeMonsterPatrolPathManager")
			.def("path",					static_cast<void (CALifeMonsterPatrolPathManager::*)(LPCSTR)>(&CALifeMonsterPatrolPathManager::path))
			.def("start_type",				static_cast<void (CALifeMonsterPatrolPathManager::*)(const EPatrolStartType&)>(&
				     CALifeMonsterPatrolPathManager::start_type))
			.def("start_type",				static_cast<const EPatrolStartType &(CALifeMonsterPatrolPathManager::*)() const>(&
				     CALifeMonsterPatrolPathManager::start_type))
			.def("route_type",				static_cast<void (CALifeMonsterPatrolPathManager::*)(const EPatrolRouteType&)>(&
				     CALifeMonsterPatrolPathManager::route_type))
			.def("route_type",				static_cast<const EPatrolRouteType &(CALifeMonsterPatrolPathManager::*)() const>(&
				     CALifeMonsterPatrolPathManager::route_type))
			...
			.def("use_randomness",			static_cast<void (CALifeMonsterPatrolPathManager::*)(const bool&)>(&CALifeMonsterPatrolPathManager::use_randomness))
			.def("use_randomness",			static_cast<bool (CALifeMonsterPatrolPathManager::*)() const>(&CALifeMonsterPatrolPathManager::use_randomness))
