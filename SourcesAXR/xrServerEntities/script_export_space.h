...
struct script_exporter1: public script_exporter_base {
	...
	script_exporter1() {
		//get_script_export_container()[script_exporter_key<T>::GetKey()] = { false, {}, nullptr };
...
struct script_exporter2 : public script_exporter_base {
	...
	script_exporter2() {
		...
		value.exporter = this;
		//get_script_export_container().insert({ script_exporter_key<T>::GetKey(), { false, { script_exporter_key<A1>::GetKey() }} })
