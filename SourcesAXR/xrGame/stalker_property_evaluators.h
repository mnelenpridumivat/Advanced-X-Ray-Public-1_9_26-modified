...
public:
						CStalkerPropertyEvaluatorReadyToKill	(CAI_Stalker *object = nullptr, LPCSTR evaluator_name = "", u32 min_ammo_count = 0);
	_value_type	evaluate						() override;
};
...
public:
						CStalkerPropertyEvaluatorReadyToKillSmartCover	(CAI_Stalker *object = nullptr, LPCSTR evaluator_name = "", u32 min_ammo_count = 0);
	_value_type	evaluate						() override;
};
...
public:
						CStalkerPropertyEvaluatorShouldThrowGrenade		(CAI_Stalker *object = nullptr, LPCSTR evaluator_name = "");
	_value_type	evaluate										() override;
};
...
public:
						CStalkerPropertyEvaluatorTooFarToKillEnemy	(CAI_Stalker *object = nullptr, LPCSTR evaluator_name = "");
	_value_type	evaluate									() override;
};
...
public:
						CStalkerPropertyEvaluatorLowCover	(CAI_Stalker *object = nullptr, LPCSTR evaluator_name = "");
	_value_type	evaluate							() override;
};
