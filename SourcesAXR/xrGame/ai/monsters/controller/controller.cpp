...
/*
	...
	time_control_hit_started	= CRenderDevice::GetInstance()->dwTimeGlobal;
*/
}
...
void CController::UpdateCL()
{
	...
	if (active_control_fx) {
		...
		float percent		= static_cast<float>(CRenderDevice::GetInstance()->dwTimeGlobal - time_control_hit_started) / static_cast<float>(time_to_show);
		...
		if (percent < TEXTURE_SIZE_PERCENT ) {
			...
			float x1 = CRenderDevice::GetInstance()->dwWidth  / 2 - ((CRenderDevice::GetInstance()->dwWidth	/ 2) * percent);
			float y1 = CRenderDevice::GetInstance()->dwHeight / 2 - ((CRenderDevice::GetInstance()->dwHeight	/ 2) * percent);
			float x2 = CRenderDevice::GetInstance()->dwWidth  / 2 + ((CRenderDevice::GetInstance()->dwWidth	/ 2) * percent);
			float y2 = CRenderDevice::GetInstance()->dwHeight / 2 + ((CRenderDevice::GetInstance()->dwHeight	/ 2) * percent);
			...
			float x1 = CRenderDevice::GetInstance()->dwWidth  / 2 - ((CRenderDevice::GetInstance()->dwWidth	/ 2) * percent2);
			float y1 = CRenderDevice::GetInstance()->dwHeight / 2 - ((CRenderDevice::GetInstance()->dwHeight	/ 2) * percent2);
			float x2 = CRenderDevice::GetInstance()->dwWidth  / 2 + ((CRenderDevice::GetInstance()->dwWidth	/ 2) * percent2);
			float y2 = CRenderDevice::GetInstance()->dwHeight / 2 + ((CRenderDevice::GetInstance()->dwHeight	/ 2) * percent2);
