...
void CStalkerDangerGrenadePlanner::add_evaluators			()
{
	...
	add_evaluator			(eWorldPropertyCoverReached		,xr_new<CStalkerPropertyEvaluatorMember>					(static_cast<CPropertyStorage*>(0),eWorldPropertyCoverReached,true,true,"danger grenade : cover reached"));
	...
	add_evaluator			(eWorldPropertyLookedAround		,xr_new<CStalkerPropertyEvaluatorMember>					(static_cast<CPropertyStorage*>(0),eWorldPropertyLookedAround,true,true,"danger grenade : looked around"));
}
