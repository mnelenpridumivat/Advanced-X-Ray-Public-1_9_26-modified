...
void SPuddle::make_xform()
{
	...
	xform.scale(scale_coeff, scale_coeff, scale_coeff);		// êîíñòàíòà - îáðàòíûé ðàäèóñ ìîäåëè (14:05:2014 ðàäèóñ ðàâåí 50)
...
void CPuddles::Load()
{
	...
	// ìîæíî áûëî ýêñïîðòèðîâàòü èç ðåíäåðà CModelPool->Instance_Load, äà íó íàôèã âîçèòüñÿ
	string_path		fn;
