...
public:
			...
			void			register_to_process	()
	{
		...
		if (CRenderDevice::GetInstance()->dwTimeGlobal < m_last_fail_time + time_to_wait_after_fail )
			return;

		CRenderDevice::GetInstance()->seqParallel.push_back	(fastdelegate::FastDelegate0<>(this,&CLevelPathBuilder::process));
	}
