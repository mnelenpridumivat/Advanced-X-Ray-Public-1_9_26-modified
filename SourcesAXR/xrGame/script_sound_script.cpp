...
void CScriptSound::script_register(lua_State *L)
{
	...
	[
		...
		class_<CScriptSound>("sound_object")
			...
			.def("play",						static_cast<void (CScriptSound::*)(CScriptGameObject*)>(&CScriptSound::Play))
			.def("play",						static_cast<void (CScriptSound::*)(CScriptGameObject*, float)>(&CScriptSound::Play))
			.def("play",						static_cast<void (CScriptSound::*)(CScriptGameObject*, float, int)>(&CScriptSound::Play))
			.def("play_at_pos",					static_cast<void (CScriptSound::*)(CScriptGameObject*, const Fvector&)>(&CScriptSound::PlayAtPos))
			.def("play_at_pos",					static_cast<void (CScriptSound::*)(CScriptGameObject*, const Fvector&, float)>(&CScriptSound::PlayAtPos))
			.def("play_at_pos",					static_cast<void (CScriptSound::*)(CScriptGameObject*, const Fvector&, float, int)>(&CScriptSound::PlayAtPos))
